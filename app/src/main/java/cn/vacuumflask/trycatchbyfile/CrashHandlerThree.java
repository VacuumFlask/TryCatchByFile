 ...
 */
public class CrashHandlerThree implements Thread.UncaughtExceptionHandler {
    /**
     ...
     * CrashHandler实例
     */
    private static CrashHandlerThree INSTANCE;
    /** 程序的Context对象 */

    /**
     * 保证只有一个CrashHandler实例
     */
    private CrashHandlerThree() {
    }

    /**
     * 获取CrashHandler实例 ,单例模式
     */
    public static CrashHandlerThree getInstance() {
        if (INSTANCE == null) {
            INSTANCE = new CrashHandlerThree();
        }
        return INSTANCE;
    }
